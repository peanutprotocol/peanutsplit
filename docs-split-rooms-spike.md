...
| Money math    | `src/split/math.ts`                                                                  | BigInt minor units everywhere (stringified over the wire). Equal split = largest-remainder; balances always sum to zero; `simplifyDebts` = greedy min-cash-flow.                                                                                                |
