 ...
 *
 * SPDX-FileCopyrightText: Squirrel Labs Ltd
 ...
 *
 * This module is an aggregate. Most drawings are Squirrel Labs work under the AGPL, but the
 * expense-subject set is traced from Lucide (ISC), part of which Lucide derives from Feather (MIT).
 * Those notices have to travel with any copy of this file — see THIRD_PARTY_NOTICES.md.
 *
