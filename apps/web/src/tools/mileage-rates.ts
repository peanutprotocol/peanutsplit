...
export const MILEAGE_RATES: readonly MileageRate[] = [
    ...
    },
    {
        ...
        rate: 0.3,
        currency: 'EUR',
        note: '0.30 EUR a kilometre, the travel rate for a car under the federal travel-expenses act. The 0.38 commuting allowance is a different regime, counted one way between home and work, and it is not this one.',
