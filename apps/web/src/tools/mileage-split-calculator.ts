...
export const mileageSplitCalculator: Tool = {
    ...
    copy: {
        ...
        intro: [
            'Calculate what each passenger pays the driver from the distance and cost per mile or kilometre. Choose whether the driver shares the cost too.',
        ],
        inputTitle: '1. Trip details',
        rowsTitle: '2. Who is sharing?',
        rowsHelp: 'Count passengers only. Choose below whether the driver pays a share too.',
        optionalTitle: 'Add names or unequal shares',
        optionalHelp: 'Use 1 for the full trip or 0.5 for half the distance. Matching shares split the cost equally.',
        resultTitle: 'Trip cost split',
        resultHint: 'Enter the number of passengers, excluding the driver.',
        roundingNote: 'Shares are rounded to the currency’s smallest unit and add up to the trip cost.',
        copyLabel: 'Copy this split',
        copyDone: 'Copied',
        method: {
    ...
    choices: [
        {
            name: 'country',
            label: 'Country',
            help: 'Sets the distance unit, currency and suggested rate. You can edit the rate below.',
            defaultValue: 'GB',
    ...
    fields: [
        {
            ...
            help: 'Include the return journey if it is shared.',
            unitChoice: 'country',
            defaultValue: 300,
            min: 0,
            step: 1,
        },
        {
            ...
            kind: 'number',
            label: 'Mileage rate',
            help: 'A suggested rate for fuel and other running costs. Use an amount your group agrees on.',
            unitChoice: 'country',
            currency: true,
            defaultValue: 0.55,
            min: 0,
        ...
        },
        {
            name: 'passengers',
            kind: 'count',
            label: 'Passengers (excluding driver)',
            help: 'Include everyone who rode along, even if they joined for part of the trip.',
            defaultValue: 3,
            min: 1,
            max: 8,
        },
        {
            name: 'driverShares',
            kind: 'toggle',
            label: 'Driver pays a share',
            help: 'Off: passengers cover the full cost. On: the driver pays one share too.',
            defaultValue: 0,
        },
    ],
    rows: {
        ...
        columns: [
            {
                ...
                kind: 'number',
                label: 'Share of trip',
                help: '1 = the full trip. 0.5 = half the distance.',
                defaultValue: 1,
                min: 0,
                step: 0.5,
            },
    ...
    builder: {
        target: 'rate',
        title: 'Calculate your own rate',
        summary: 'Calculate a rate from fuel use',
        intro: 'Calculate fuel cost per mile or kilometre. You can add an agreed amount for wear and depreciation.',
        fields: [
            {
                name: 'fuelPer100',
                kind: 'number',
                ...
                unitChoice: 'country',
                unitBasis: 100,
                help: 'Litres used over 100 miles or 100 kilometres, matching the trip’s distance unit.',
                defaultValue: 7,
                min: 0,
                step: 0.1,
            },
            ...
            },
            {
                ...
                help: 'Add a cost per mile or kilometre for wear and depreciation. Leave at zero to split fuel only.',
                defaultValue: 0,
                min: 0,
                step: 0.01,
            },
        ],
        floorLabel: 'Fuel cost per distance',
        totalLabel: 'Your rate per distance',
    ...
    phrases: {
        ...
        costLabel: 'Total trip cost',
        shareDetail: '{share} of {total} shares',
        driverLabel: 'Driver',
        driverDetail: 'Covered by the driver',
    },
