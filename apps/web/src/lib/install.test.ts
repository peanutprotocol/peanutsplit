...
describe('deriveInstallState', () => {
    ...
    it('lets a live canonical prompt win over room-shortcut repair', () => {
        expect(deriveInstallState(env({ isStandalone: true, isRoomPath: true, hasPrompt: true }))).toBe('promptable')
    })
