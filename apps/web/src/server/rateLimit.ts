// duplicated from wave0/correctness — coordinator dedupes at merge. The block at
// the foot of the file (`enforceRateLimitOn`) is the accounts wave's only
// addition; keep it when the two copies collapse into one.
/**
